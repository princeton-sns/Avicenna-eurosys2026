...
#set key bottom right width 1.5
set key top left width 1 height 0
if (!exists("filename0")) filename0='notfound'
if (!exists("filename1")) filename1='notfound'
if (!exists("outfilename")) outfilename='notfound'
if (!exists("sysname0")) sysname0='notfound'
if (!exists("sysname1")) sysname1='notfound'
...
exp_dir1="./"
plot filename0 using ($1/1000000):($2/1000) title sysname0 w points ls 2 pt 1 ps 1, \
filename1 using ($1/1000000):($2/1000) title sysname1 w points ls 3 pt 2 ps 1, 

# plot filename1 using ($1/1000000):($2/1000) title sysname1 w points ls 3 pt 2 ps 1, \
#  filename0 using ($1/1000000):($2/1000) title sysname0 w points ls 2 pt 4 ps 1, 
# plot for [i=0:0] 'avicenna/avicenna/processed/c'.i.'.txt' using ($1/1000000000):($2/1000) title "Avicenna"  w points ls 2 pt 2 ps 1, \
# for [i=1:179] 'avicenna/avicenna/processed/c'.i.'.txt' using ($1/1000000000):($2/1000) notitle w points ls 2 pt 2 ps 1, \
##############