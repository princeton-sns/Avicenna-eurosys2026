...
serverFile1="$(pwd)/experimentscripts/configs/serverconfig1.txt"
serverFile2="$(pwd)/experimentscripts/configs/serverconfig2.txt"
serverFile3="$(pwd)/experimentscripts/configs/serverconfig3.txt"
serverFile4="$(pwd)/experimentscripts/configs/serverconfig4.txt"
serverFile5="$(pwd)/experimentscripts/configs/serverconfig5.txt"
serverFile6="$(pwd)/experimentscripts/configs/serverconfig6.txt"
serverFile7="$(pwd)/experimentscripts/configs/serverconfig7.txt"
