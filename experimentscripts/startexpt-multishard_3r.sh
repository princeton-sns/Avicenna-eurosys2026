...
serverFile1="$(pwd)/experimentscripts/configs/serverconfig1_3r.txt"
serverFile2="$(pwd)/experimentscripts/configs/serverconfig2_3r.txt"
serverFile3="$(pwd)/experimentscripts/configs//serverconfig3_3r.txt"
