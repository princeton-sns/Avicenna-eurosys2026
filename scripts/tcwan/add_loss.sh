...
sudo tc qdisc replace dev ifb1 root netem delay ${CUR_LATENCY}ms loss ${LOSS_PERCENT}%
sudo tc qdisc replace dev ifb2 root netem delay 0ms loss ${LOSS_PERCENT}%
sudo tc qdisc replace dev ifb3 root netem delay 0ms loss ${LOSS_PERCENT}%
