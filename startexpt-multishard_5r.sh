...
serverFile1="/proj/cops/zijian/Avicenna-zijian/serverconfig1_5r.txt"
serverFile2="/proj/cops/zijian/Avicenna-zijian/serverconfig2_5r.txt"
serverFile3="/proj/cops/zijian/Avicenna-zijian/serverconfig3_5r.txt"
serverFile4="/proj/cops/zijian/Avicenna-zijian/serverconfig4_5r.txt"
serverFile5="/proj/cops/zijian/Avicenna-zijian/serverconfig5_5r.txt"
  ...
  for s in $(seq 1 $shards); do
    ...
    ssh -o StrictHostKeyChecking=no node-$i "\
      ...
      bin/server -maddr='${masterAddr}' -mport='${mport}' -addr='node-$i' \
        -port='${sport}' -e='${doEpaxos}' -copilot='${doCopilot}' -latentcopilot='${doLatentCopilot}' -domr99rsm='${doMr99rsm}' -dofvc='${doFvc}' \
